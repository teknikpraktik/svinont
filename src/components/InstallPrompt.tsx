...
const DISMISSED_KEY = "svinont:install-prompt-dismissed";
  ...
  return (
    <div className={styles.box}>
      <div className={styles.header}>
        <p className={styles.title}>Installera Svinont</p>
        <IconButton icon="×" ariaLabel="Stäng installationsinformation" onClick={dismiss} />
      </div>

      <p className={styles.text}>
        Lägg Svinont på hemskärmen för snabbare start och en bättre appupplevelse.
      </p>
